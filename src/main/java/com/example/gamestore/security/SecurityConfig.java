    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/games/*/image", "/games/*/image").hasRole("ADMIN")
                        ...
                        .requestMatchers("/api/orders", "/api/orders/**", "/orders", "/orders/**").authenticated()
                        .requestMatchers("/api/wishlist/**").authenticated()
                        .requestMatchers("/api/payments/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/games", "/api/games/", "/games", "/games/").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/games/**", "/games/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/games/**", "/games/**").hasRole("ADMIN")
